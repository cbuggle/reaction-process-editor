export const tooltips = {
	'selection_unavailable': "The selected item is no longer available in the ELN automation setup. Only the currently available automation setup can be selected when editing.",
