    ...
    <Form>
      ...
      <SingleLineFormGroup label="Reaction Name">
        <Input
          ...
          onChange={(event) =>
            onInputChange({ name: "name", value: event.target.value })
          }
        />
      </SingleLineFormGroup>
      <MultiInputFormGroup label="Conducted by" typeColor="primary">
        <SingleLineFormGroup label="Username">
          <Input
            value={provenanceForm.username}
            placeholder="Conducted by"
            onChange={(event) =>
              onInputChange({ name: "username", value: event.target.value })
            }
            disabled={true}
          />
        </SingleLineFormGroup>
        <SingleLineFormGroup label="Email">
          <Input
            ...
            placeholder="Email"
            onChange={(event) =>
              onInputChange({ name: "email", value: event.target.value })
            }
            disabled={true}
          />
        </SingleLineFormGroup>
      ...
      <SingleLineFormGroup label="Place (City)">
        <Input
          ...
          onChange={(event) =>
            onInputChange({ name: "city", value: event.target.value })
          }
        />
      </SingleLineFormGroup>
      <SingleLineFormGroup label="DOI">
        <Input
          ...
          placeholder="DOI"
          onChange={(event) =>
            onInputChange({ name: "doi", value: event.target.value })
          }
        />
      </SingleLineFormGroup>
      <SingleLineFormGroup label="Patent">
        <Input
          ...
          placeholder="Patent"
          onChange={(event) =>
            onInputChange({ name: "patent", value: event.target.value })
          }
        />
      </SingleLineFormGroup>
      ...
      <SingleLineFormGroup label="Orcid">
        <Input
          ...
          placeholder="Orcid"
          onChange={(event) =>
            onInputChange({ name: "orcid", value: event.target.value })
          }
        />
      </SingleLineFormGroup>
      <SingleLineFormGroup label="Organisation">
        <Input
          ...
          onChange={(event) =>
            onInputChange({ name: "organization", value: event.target.value })
          }
        />
      </SingleLineFormGroup>
